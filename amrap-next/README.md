# AMRAP (legacy Next.js)

> **Archive.** The default app is SvelteKit at the **repo root**. This folder is the previous Next.js implementation kept for reference. Prefer developing in `/` unless you specifically need Next.
